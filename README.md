...
> *Раньше обслуживал Boeing 737-777. Теперь создаю надёжный backend-код на Python.*  
> *Инженерный подход + внимание к деталям = системы, которые работают.*

Ищу первую коммерческую позицию **Python Backend Developer**. Открыт к удалённой работе, готов к переезду.
...
[**Код →**](https://github.com/Chashkapluy1/foodgram-project-react)
